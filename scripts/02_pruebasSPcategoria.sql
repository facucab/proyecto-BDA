...
--Caso normal
EXEC actividades.CrearCategoria @nombre_categoria = 'Menor', @costo_membrecia = 1500.00,@edad_maxima = 12;
EXEC actividades.CrearCategoria @nombre_categoria = 'Cadete', @costo_membrecia = 2000.00,@edad_maxima = 17;
EXEC actividades.CrearCategoria @nombre_categoria = 'Mayor', @costo_membrecia = 2500.00,@edad_maxima = 50;
EXEC actividades.CrearCategoria @nombre_categoria = 'Veterano', @costo_membrecia = 2000.00,@edad_maxima = 70;
-- Resultado: Categoria crada correctamente

--Nombre vacio
EXEC actividades.CrearCategoria @nombre_categoria = '', @costo_membrecia = 900.00,@edad_maxima = 40;--Resultado: El nombre de la categora no puede estar vaco

-- costo de membresia menor o igual a 0
EXEC actividades.CrearCategoria @nombre_categoria = 'Adulto Joven', @costo_membrecia = -900.00,@edad_maxima = 40;
EXEC actividades.CrearCategoria @nombre_categoria = 'Jubilado', @costo_membrecia = 0,@edad_maxima = 40;
-- Resultado: El costo de membresa debe ser mayor a cero

-- Edad menor o igual a 0
EXEC actividades.CrearCategoria @nombre_categoria = 'Bebe', @costo_membrecia = 900.00,@edad_maxima = 0;
EXEC actividades.CrearCategoria @nombre_categoria = 'Bebe', @costo_membrecia = 900.00,@edad_maxima = -5;
-- Resultado: La edad maxima debe estar entre 1 y 120 años

-- Edad mayor a 120
EXEC actividades.CrearCategoria @nombre_categoria = 'Super Centenario', @costo_membrecia = 900.00,@edad_maxima = 150;
-- Resultado: La edad maxima debe estar entre 1 y 120 años

-- Nombre duplicado (considerando normalización a mayúsculas)
EXEC actividades.CrearCategoria @nombre_categoria = 'menor', @costo_membrecia = 1800.00,@edad_maxima = 13;-- Resultado: Ya existe una categora con ese nombre

-- Solapamiento de edades - edad mxima dentro del rango existente
EXEC actividades.CrearCategoria @nombre_categoria = 'Pre-adolescente', @costo_membrecia = 1800.00, @edad_maxima = 14;
...
EXEC actividades.CrearCategoria @nombre_categoria = 'Adulto', @costo_membrecia = 3000.00, @edad_maxima = 40;
...
EXEC actividades.CrearCategoria @nombre_categoria = 'Veterano', @costo_membrecia = 2100.00,@edad_maxima = 80;
